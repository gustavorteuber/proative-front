    ...
    >
      <div class="px-8">
        <div class="flex items-center justify-between">
          <div class="w-32">
            <div
              class="text-xl font-extrabold leading-6 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400"
            >
              Proative
            </div>
          </div>
      ...
      <div
        class="px-8 py-4 w-full border-t border-gray-800 flex items-center text-gray-600 uppercase text-xs"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
