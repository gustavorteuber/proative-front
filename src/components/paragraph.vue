<template>
  <p
    class="mb-3 font-light text-gray-500 dark:text-gray-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-emerald-500 dark:first-letter:text-gray-100 first-letter:mr-3 first-letter:float-left"
  >
