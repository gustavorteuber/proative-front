...
export default {
  ...
  methods: {
    ...
    colorMidia() {
      if (this.isDark == true) {
        return "px-4 py-6 bg-neutral-500 md:flex md:items-center md:justify-between rounded-3xl";
      } else {
        return "px-4 py-6 bg-emerald-500 md:flex md:items-center md:justify-between rounded-3xl";
      }
    },
  },
};
...
<template>
  <body>
    <footer :class="colorFooter()">
      ...
      <div :class="colorMidia()">
        <span class="text-sm text-neutral-900 sm:text-center"
          >© 2023 <a href="https://flowbite.com/">Proative™</a>. Todos os
          direitos reservados.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
          <a href="#" class="text-neutral-900 hover:text-neutral-900">
            <svg
              class="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
